<template>
  <div class="row container-fluid my-2 my-lg-4 main-container">
    <!--ingredients-->
    <div class="col-xl-7 p-0 pl-xl-3 pr-xl-4" id="ingredients-table">
      <h2 class="ingredient-list-header mx-3 mx-lg-0 mb-0 mb-lg-3">
      ...
      <table class="table">
        ...
        <tbody>
          <tr
            ...
            :key="index"
            :class="editedIngredientRowClass(index)"
          >
            <td>
    ...
    <!--units-->
    <div class="col-xl-5 p-0 pr-xl-3 pl-xl-4" id="units-table">
      <h2 class="ingredient-list-header mx-3 mx-lg-0 mb-0 mb-lg-3">
      ...
      <table class="table">
        ...
        <tbody>
          <tr
            v-for="(unit, index) in units"
            :key="index"
            :class="editedUnitRowClass(index)"
          >
            <td>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <b> {{ ingredients[deletedIngredientIndex].ingredient_name }}</b>
              z listy składników ?
            </div>
...
export default {
  ...
  async mounted() {
    ...
    this.getUnits();
    await this.ingredients.sort(this.compare);
  },
  methods: {
    async getIngredients() {
      try {
        let response = await axios.get(
          "http://localhost/food_tracker/process.php?action=get_ingredients"
        );
